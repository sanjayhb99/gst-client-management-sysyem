...
FROM product where product_name= '$product_name'";
 ...
 echo"</table>";
         ...
         $query = "UPDATE product_left SET  quantity_stock =(quantity_stock+'$quantity') WHERE gstin_fk='$gstin_fk' AND product_name='$product_name'";
         $result = mysqli_query($dbh,$query);
 	                                                                                
		 $query = "INSERT INTO product_left VALUES('$gstin_fk','$product_name','$quantity')";
         $result = mysqli_query($dbh,$query);
